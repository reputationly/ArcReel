...
export default {
  ...
  'content_mode_mv_desc': '一支 MV——先定曲风与歌词、作曲合成人声，再按歌曲段落表把镜头钉在时间轴上；演唱镜头由歌声驱动口型。',
  ...
  'not_configured_option': '未配置',
  'not_configured_hint': '生成时将提示先配置',
  'default_music_model': '默认作曲模型',
  'default_music_model_hint': '生成配乐与歌曲；与旁白配音是不同模型（如 ACE-Step）',
  'default_singing_model': '默认歌声模型',
  'default_singing_model_hint': '把伴奏唱成人声；与作曲是不同模型（如 SoulX-Singer）',
  'default_lip_sync_model': '口型驱动模型',
  'default_lip_sync_model_hint': 'MV 演唱镜头用歌声驱动人物口型；需支持数字人的模型（如 InfiniteTalk），其余镜头仍走上面的视频模型',
  ...
  'frame_interpolation': '插帧',
  'frame_interpolation_hint': '（帧率翻倍，画面更流畅；仅部分自建模型支持）',
  'image_quality_mode': '质量档',
  'image_quality_mode_hint': '（模型先思考并改写提示词再出图，更贴合描述，耗时约 2.8 倍；仅混元图像 3.0 支持）',
  ...
  'chatcut_export_started': 'OpenChatCut 工程文件已开始下载',
  'chatcut_export_failed': '导出 OpenChatCut 工程失败：{{message}}',
  ...
  'export_group_archive': '备份与迁移',
  'export_group_handoff': '交给剪辑软件',
  'export_chatcut_handoff': '导出为 OpenChatCut 工程',
  'chatcut_handoff_hint': '单个 JSON，素材按需拉取，附带角色与段落结构',
  'export_handoff': '导出工程',
  'select_episode': '选择集数',
  ...
  'next_step_title': '建议下一步',
  'next_step_fill_label': '填入输入框',
  'next_step_upload_source_label': '导入小说原文',
  'next_step_upload_source_desc': '到左侧「源文件」上传 txt / docx / epub / pdf，之后才能生成剧本。',
  'next_step_fill_product_label': '填写产品信息与创作 Brief',
  'next_step_fill_product_desc': '在「项目概览」填产品名称、描述与创作 Brief，勾选生成标准产品参考图后开始创作。',
  'next_step_write_song_label': '先写歌：定曲风与歌词',
  'next_step_write_song_desc': '在对话里说出你想要的曲风与大致内容，让智能体优化歌词、作曲并合成人声——镜头表要按歌曲实测时长来排，没有歌就排不了镜头。',
  'next_step_generate_script_label': '生成剧本',
  'next_step_generate_script_desc': '让智能体把已有素材拆成分集与镜头脚本。',
  'next_step_generate_script_prompt': '生成剧本，按项目已有的素材与设定来。',
  'next_step_complete_assets_label': '补齐设计图',
  'next_step_complete_assets_desc': '角色、场景、道具的设计图还没出齐。先补齐再往下走，否则每个镜头里的人和场景会长得不一样。',
  'next_step_complete_assets_prompt': '把剧本里出现的角色、场景、道具都补齐设计图，风格与项目设定保持一致。',
  'next_step_generate_storyboards_label': '生成分镜图',
  'next_step_generate_storyboards_desc': '分镜图是图生视频的首帧，图错了视频必错，出图后先审一遍。',
  'next_step_generate_storyboards_prompt': '按剧本逐镜生成分镜图。',
  'next_step_generate_videos_label': '生成视频',
  'next_step_generate_videos_desc': '按镜头逐条生成视频。这一步耗时最长，也会产生实际费用。',
  'next_step_generate_videos_prompt': '按剧本逐镜生成视频。',
  'next_step_export_label': '导出成片',
  'next_step_export_desc': '所有镜头已完成，可从右上角「导出」下载成片或剪映草稿。',
  ...
  'max_reference_images_label': '参考图上限',
  'max_reference_images_placeholder': '留空跟随系统判定',
  'max_reference_images_placeholder_with_system': '留空跟随系统判定（当前 {{count}} 张）',
  'max_reference_images_help': '该模型单次可接受几张主体参考图。中转站背后挂的模型能力系统猜不准，猜错会导致参考生视频不可用；填 0 表示明确不支持。',
  'max_reference_images_invalid': '请填写 0 或正整数',
  ...
  'endpoint_newapi_music_display': 'NewAPI 音乐（ACE-Step）',
  ...
  'tool_name_generate_music': '生成音乐',
  'tool_name_generate_singing': '合成歌声',
  ...
  'skill_name_generate_music': '生成音乐',
  'skill_name_generate_singing': '合成歌声',
  'skill_name_write_song': '写歌',
  ...
  'detail_section_lyrics_line': '歌词行',
  'detail_lyrics_line_placeholder': '该镜头对应的歌词；纯器乐段留空',
  'detail_mv_section_placeholder': '所属歌曲段落，如 verse / chorus',
