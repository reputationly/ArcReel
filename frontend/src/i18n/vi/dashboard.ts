...
export default {
  ...
  'content_mode_mv_desc': 'M\u1ed9t MV \u2014 ch\u1ed1t phong c\u00e1ch v\u00e0 l\u1eddi tr\u01b0\u1edbc, so\u1ea1n nh\u1ea1c v\u00e0 t\u1ed5ng h\u1ee3p gi\u1ecdng h\u00e1t, r\u1ed3i g\u0103m c\u00e1c c\u1ea3nh quay theo d\u00f2ng th\u1eddi gian c\u1ee7a b\u00e0i h\u00e1t; c\u1ea3nh h\u00e1t \u0111\u01b0\u1ee3c kh\u1edbp kh\u1ea9u h\u00ecnh theo gi\u1ecdng.',
  ...
  'not_configured_option': 'Ch\u01b0a c\u1ea5u h\u00ecnh',
  'not_configured_hint': 'Khi t\u1ea1o s\u1ebd y\u00eau c\u1ea7u c\u1ea5u h\u00ecnh tr\u01b0\u1edbc',
  'default_music_model': 'Mô hình nhạc mặc định',
  'default_music_model_hint': 'Sáng tác nhạc nền và bài hát; khác với mô hình lồng tiếng (ví dụ ACE-Step)',
  'default_singing_model': 'Mô hình giọng hát mặc định',
  'default_singing_model_hint': 'Hát trên nền nhạc; khác với mô hình sáng tác (ví dụ SoulX-Singer)',
  'default_lip_sync_model': 'Mô hình khẩu hình',
  'default_lip_sync_model_hint': 'Dùng giọng hát điều khiển khẩu hình nhân vật cho cảnh biểu diễn MV; cần mô hình người kỹ thuật số (ví dụ InfiniteTalk). Các cảnh khác vẫn dùng mô hình video ở trên',
  ...
  'frame_interpolation': 'Nội suy khung hình',
  'frame_interpolation_hint': '(Tăng gấp đôi tốc độ khung hình cho chuyển động mượt hơn; chỉ một số mô hình tự triển khai hỗ trợ)',
  'image_quality_mode': 'Chế độ chất lượng',
  'image_quality_mode_hint': '(Mô hình suy luận và viết lại câu lệnh trước khi vẽ — bám sát mô tả hơn, chậm khoảng 2,8 lần; chỉ HunyuanImage 3.0 hỗ trợ)',
  ...
  'chatcut_export_started': 'Đã bắt đầu tải tệp dự án OpenChatCut',
  'chatcut_export_failed': 'Xuất cho OpenChatCut thất bại: {{message}}',
  ...
  'export_group_archive': 'Sao lưu & di chuyển',
  'export_group_handoff': 'Chuyển sang trình dựng phim',
  'export_chatcut_handoff': 'Xuất cho OpenChatCut',
  'chatcut_handoff_hint': 'Một tệp JSON; tài nguyên được tải khi cần, kèm cấu trúc nhân vật và phân đoạn',
  'export_handoff': 'Xuất dự án',
  ...
  'next_step_title': 'Bước tiếp theo được đề xuất',
  'next_step_fill_label': 'Điền vào ô nhập',
  'next_step_upload_source_label': 'Nhập bản gốc tiểu thuyết',
  'next_step_upload_source_desc': 'Tải lên tệp txt / docx / epub / pdf ở mục «Tệp nguồn» bên trái — kịch bản được tạo từ đó.',
  'next_step_fill_product_label': 'Điền thông tin sản phẩm và Brief',
  'next_step_fill_product_desc': 'Ở «Tổng quan dự án», nhập tên sản phẩm, mô tả và Brief sáng tạo, tích «tạo ảnh tham chiếu sản phẩm chuẩn» rồi bắt đầu.',
  'next_step_write_song_label': 'Vi\u1ebft b\u00e0i h\u00e1t tr\u01b0\u1edbc: phong c\u00e1ch v\u00e0 l\u1eddi',
  'next_step_write_song_desc': 'H\u00e3y m\u00f4 t\u1ea3 phong c\u00e1ch v\u00e0 n\u1ed9i dung mong mu\u1ed1n trong h\u1ed9i tho\u1ea1i; tr\u1ee3 l\u00fd s\u1ebd tinh ch\u1ec9nh l\u1eddi, so\u1ea1n nh\u1ea1c v\u00e0 t\u1ed5ng h\u1ee3p gi\u1ecdng h\u00e1t. C\u1ea3nh quay \u0111\u01b0\u1ee3c s\u1eafp theo th\u1eddi l\u01b0\u1ee3ng \u0111o \u0111\u01b0\u1ee3c c\u1ee7a b\u00e0i h\u00e1t.',
  'next_step_generate_script_label': 'Tạo kịch bản',
  'next_step_generate_script_desc': 'Để trợ lý chia tư liệu hiện có thành các tập và phân cảnh.',
  'next_step_generate_script_prompt': 'Hãy tạo kịch bản dựa trên tư liệu và thiết lập đã có trong dự án.',
  'next_step_complete_assets_label': 'Hoàn thiện ảnh thiết kế',
  'next_step_complete_assets_desc': 'Vẫn thiếu ảnh thiết kế cho một số nhân vật, bối cảnh hoặc đạo cụ. Hoàn thiện trước, nếu không người và cảnh trong mỗi phân cảnh sẽ trông khác nhau.',
  'next_step_complete_assets_prompt': 'Hãy tạo đủ ảnh thiết kế cho mọi nhân vật, bối cảnh và đạo cụ xuất hiện trong kịch bản, giữ đúng phong cách dự án.',
  'next_step_generate_storyboards_label': 'Tạo ảnh phân cảnh',
  'next_step_generate_storyboards_desc': 'Ảnh phân cảnh là khung hình đầu cho việc tạo video từ ảnh: ảnh sai thì video chắc chắn sai, hãy duyệt lại sau khi tạo.',
  'next_step_generate_storyboards_prompt': 'Hãy tạo ảnh phân cảnh cho từng cảnh quay trong kịch bản.',
  'next_step_generate_videos_label': 'Tạo video',
  'next_step_generate_videos_desc': 'Dựng từng cảnh quay. Đây là bước lâu nhất và phát sinh chi phí thực tế.',
  'next_step_generate_videos_prompt': 'Hãy tạo video cho từng cảnh quay trong kịch bản.',
  'next_step_export_label': 'Xuất phim',
  'next_step_export_desc': 'Mọi cảnh quay đã xong — dùng «Xuất» ở góc trên bên phải để tải phim hoặc bản nháp JianYing.',
  ...
  'max_reference_images_label': 'Giới hạn ảnh tham chiếu',
  'max_reference_images_placeholder': 'Để trống để theo hệ thống',
  'max_reference_images_placeholder_with_system': 'Để trống để theo hệ thống (hiện tại {{count}})',
  'max_reference_images_help': 'Số ảnh tham chiếu chủ thể mà mô hình nhận mỗi lần gọi. Hệ thống không thể đoán chính xác năng lực của mô hình phía sau cổng trung chuyển, đoán sai sẽ khiến tạo video từ ảnh tham chiếu không dùng được; nhập 0 để khẳng định là không hỗ trợ.',
  'max_reference_images_invalid': 'Hãy nhập 0 hoặc số nguyên dương',
  ...
  'detail_section_lyrics_line': 'D\u00f2ng l\u1eddi b\u00e0i h\u00e1t',
  'detail_lyrics_line_placeholder': 'L\u1eddi cho c\u1ea3nh quay n\u00e0y; \u0111\u1ec3 tr\u1ed1ng cho \u0111o\u1ea1n kh\u00f4ng l\u1eddi',
  'detail_mv_section_placeholder': '\u0110o\u1ea1n b\u00e0i h\u00e1t c\u1ee7a c\u1ea3nh quay, v\u00ed d\u1ee5 verse / chorus',
  ...
  'tool_name_generate_music': 'Tạo nhạc',
  'tool_name_generate_singing': 'Tổng hợp giọng hát',
  ...
  'tool_name_patch_song': 'Ghi thông tin bài hát',
  ...
  'skill_name_generate_music': 'Tạo nhạc',
  'skill_name_generate_singing': 'Tổng hợp giọng hát',
  'skill_name_write_song': 'Viết bài hát',
