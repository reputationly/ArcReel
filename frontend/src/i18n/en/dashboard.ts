...
export default {
  ...
  'content_mode_mv_desc': 'A music video \u2014 settle the style and lyrics first, compose and synthesize vocals, then pin shots to the song\u2019s section timeline; performance shots are lip-synced to the vocal track.',
  ...
  'not_configured_hint': 'Generation will ask you to configure one first',
  'default_music_model': 'Default music model',
  'default_music_model_hint': 'Composes score and songs; a different model from narration TTS (e.g. ACE-Step)',
  'default_singing_model': 'Default singing model',
  'default_singing_model_hint': 'Sings over a backing track; a different model from composition (e.g. SoulX-Singer)',
  'default_lip_sync_model': 'Lip-sync model',
  'default_lip_sync_model_hint': 'Drives a character\u2019s mouth from the vocal track for MV performance shots; needs a digital-human model (e.g. InfiniteTalk). Other shots still use the video model above',
  ...
  'frame_interpolation_hint': '(Doubles the frame rate for smoother motion; supported by some self-hosted models only)',
  'image_quality_mode': 'Quality Mode',
  'image_quality_mode_hint': '(The model reasons and rewrites the prompt before drawing — closer to your description, about 2.8x slower; HunyuanImage 3.0 only)',
  ...
  'chatcut_export_started': 'OpenChatCut project file download started',
  'chatcut_export_failed': 'Export for OpenChatCut failed: {{message}}',
  ...
  'export_group_archive': 'Backup & transfer',
  'export_group_handoff': 'Hand off to an editor',
  'export_chatcut_handoff': 'Export for OpenChatCut',
  'chatcut_handoff_hint': 'One JSON file; media is fetched on demand, with character and section structure included',
  'export_handoff': 'Export project',
  ...
  'next_step_title': 'Suggested next step',
  'next_step_fill_label': 'Put in the composer',
  'next_step_upload_source_label': 'Import the source text',
  'next_step_upload_source_desc': 'Upload a txt / docx / epub / pdf under "Source files" on the left — the script is generated from it.',
  'next_step_fill_product_label': 'Fill in the product info and brief',
  'next_step_fill_product_desc': 'On "Project overview", enter the product name, description and creative brief, tick "generate standard product sheet", then start.',
  'next_step_write_song_label': 'Write the song first: style and lyrics',
  'next_step_write_song_desc': 'Describe the style and rough content in chat; the agent will refine the lyrics, compose, and synthesize vocals. Shots are laid out against the song\u2019s measured length, so there is nothing to lay out until the song exists.',
  'next_step_generate_script_label': 'Generate the script',
  'next_step_generate_script_desc': 'Let the agent break the material down into episodes and shots.',
  'next_step_generate_script_prompt': 'Generate the script from the material and settings already in this project.',
  'next_step_complete_assets_label': 'Complete the design sheets',
  'next_step_complete_assets_desc': 'Some character, scene or prop sheets are still missing. Finish them first — otherwise people and places will look different in every shot.',
  'next_step_complete_assets_prompt': 'Generate the missing design sheets for every character, scene and prop in the script, keeping the project style.',
  'next_step_generate_storyboards_label': 'Generate storyboards',
  'next_step_generate_storyboards_desc': 'Storyboards are the start frames for image-to-video: a wrong frame guarantees a wrong clip, so review them once they are out.',
  'next_step_generate_storyboards_prompt': 'Generate a storyboard image for every shot in the script.',
  'next_step_generate_videos_label': 'Generate the videos',
  'next_step_generate_videos_desc': 'Renders each shot. This is the slowest step and it costs real money.',
  'next_step_generate_videos_prompt': 'Generate the video for every shot in the script.',
  'next_step_export_label': 'Export the film',
  'next_step_export_desc': 'Every shot is done — use "Export" in the top right to download the film or a JianYing draft.',
  ...
  'max_reference_images_label': 'Reference image limit',
  'max_reference_images_placeholder': 'Leave blank to follow the system',
  'max_reference_images_placeholder_with_system': 'Leave blank to follow the system (currently {{count}})',
  'max_reference_images_help': 'How many subject reference images this model accepts per request. Capabilities behind a relay gateway cannot be detected reliably, and a wrong guess makes reference-to-video unusable; enter 0 to declare it unsupported.',
  'max_reference_images_invalid': 'Enter 0 or a positive integer',
  ...
  'endpoint_newapi_music_display': 'NewAPI Music (ACE-Step)',
  ...
  'tool_name_generate_music': 'Generate music',
  'tool_name_generate_singing': 'Synthesize singing',
  ...
  'tool_name_patch_song': 'Write song metadata',
  ...
  'skill_name_generate_music': 'Generate music',
  'skill_name_generate_singing': 'Synthesize singing',
  'skill_name_write_song': 'Write song',
  ...
  'detail_section_lyrics_line': 'Lyric line',
  'detail_lyrics_line_placeholder': 'Lyrics for this shot; leave empty for instrumental passages',
  'detail_mv_section_placeholder': 'Song section this shot belongs to, e.g. verse / chorus',
